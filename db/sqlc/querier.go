...
type Querier interface {
	...
	ConfirmSectionSale(ctx context.Context, arg ConfirmSectionSaleParams) (ConfirmSectionSaleRow, error)
	...
	GetAdminUserByID(ctx context.Context, id int64) (GetAdminUserByIDRow, error)
	...
	ListAdminEventSections(ctx context.Context, arg ListAdminEventSectionsParams) ([]ListAdminEventSectionsRow, error)
	...
	ReserveSectionInventory(ctx context.Context, arg ReserveSectionInventoryParams) (ReserveSectionInventoryRow, error)
